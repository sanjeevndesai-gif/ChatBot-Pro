...
<div class="contact-section">
  ...
  <div class="contact-cards">
    ...
    <div class="card qr-card">
      ...
      <!-- QR Image (generated by backend) -->
      <img [src]="supportQrUrl" alt="Support QR Code" class="qr-img" />
...
export class Faq {
  supportPhone = environment.supportPhoneNumber;

  get supportQrUrl() {
    const phone = encodeURIComponent(this.supportPhone || '');
    const topic = 'faq';
    return `${environment.apiGatewayUrl}/api/whatsapp/qr/generate?qrType=support&phoneNumber=${phone}&topic=${encodeURIComponent(topic)}`;
  }
   categories = [
